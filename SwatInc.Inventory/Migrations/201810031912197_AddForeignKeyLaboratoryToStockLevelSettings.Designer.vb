...
Namespace Migrations
    ...
    Public NotInheritable Partial Class AddForeignKeyLaboratoryToStockLevelSettings
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AddForeignKeyLaboratoryToStockLevelSettings))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201810031912197_AddForeignKeyLaboratoryToStockLevelSettings"
            End Get
        End Property
