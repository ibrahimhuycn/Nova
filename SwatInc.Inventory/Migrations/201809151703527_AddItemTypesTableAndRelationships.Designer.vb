...
Namespace Migrations
    ...
    Public NotInheritable Partial Class AddItemTypesTableAndRelationships
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AddItemTypesTableAndRelationships))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201809151703527_AddItemTypesTableAndRelationships"
            End Get
        End Property
