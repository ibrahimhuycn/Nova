...
Namespace Migrations
    ...
    Public NotInheritable Partial Class AddForeignKeyLabIdToTransactions
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AddForeignKeyLabIdToTransactions))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201809251636283_AddForeignKeyLabIdToTransactions"
            End Get
        End Property
