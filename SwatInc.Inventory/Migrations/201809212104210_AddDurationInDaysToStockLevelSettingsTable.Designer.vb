...
Namespace Migrations
    ...
    Public NotInheritable Partial Class AddDurationInDaysToStockLevelSettingsTable
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AddDurationInDaysToStockLevelSettingsTable))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201809212104210_AddDurationInDaysToStockLevelSettingsTable"
            End Get
        End Property
