...
Namespace Migrations
    ...
    Public NotInheritable Partial Class EditPurchaseOrderTableToIncludeRequiredDate
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(EditPurchaseOrderTableToIncludeRequiredDate))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201809182123393_EditPurchaseOrderTableToIncludeRequiredDate"
            End Get
        End Property
