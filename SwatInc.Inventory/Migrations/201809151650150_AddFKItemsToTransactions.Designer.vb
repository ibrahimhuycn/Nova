...
Namespace Migrations
    ...
    Public NotInheritable Partial Class AddFKItemsToTransactions
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AddFKItemsToTransactions))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201809151650150_AddFKItemsToTransactions"
            End Get
        End Property
