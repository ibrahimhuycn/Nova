...
Namespace Migrations
    ...
    Public NotInheritable Partial Class AddLotsTableAndRelationships
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AddLotsTableAndRelationships))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201809151659284_AddLotsTableAndRelationships"
            End Get
        End Property
